...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAccountDeletedException(
            AccountDeletedException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleInstructorNotFoundException(
            InstructorNotFoundException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidInstructorRoleException(
            InvalidInstructorRoleException ex, HttpServletRequest request) {

        log.warn("Invalid instructor role: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleProgressNotFoundException(
            ProgressNotFoundException ex, HttpServletRequest request) {

        log.warn("Progress not found: {}", ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> handleNotEnrolledException(
            NotEnrolledException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleUnauthorizedReviewAccessException(
            UnauthorizedReviewAccessException ex, HttpServletRequest request) {
